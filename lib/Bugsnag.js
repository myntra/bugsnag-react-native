...
_this.notify(error,null,!!NativeClient.notifyBlocking,function(queued){
if(previousHandler){
...
notify=function _callee(error,beforeSendCallback,blocking,postSendCallback,_handledState){var report,_iterator,_isArray,_i,payload;return regeneratorRuntime.async(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:if(
...
}case 28:case'end':return _context.stop();}}},null,_this);};this.
